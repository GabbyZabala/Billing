...
// Testing stuff dont mind this big comment side
...
// private String[] account_lodge = new String[99];// 99 for max usage of the
// account that can carry
...
// System.err.println("DEBUGG MODE: Account is " + (AccountisUsed ? "Actived" :
// "Not-Actived"));
...
// System.out.println("\t---Details: First[ " + firstname + " ] Last [ " +
// lastname + " ]");
// System.out.println("-- AGE:\t\t" + (age == 0 ? "[ NO DATA ] " : age));
// System.out.println("-- BLOODTYPE:\t" + (Bloodtype == null ? "[ NO DATA ] " :
// Bloodtype));
// }
...
// public void Add_Account_Lodge(String name_input) {// di ako marunong nung
// dynamic array eh
